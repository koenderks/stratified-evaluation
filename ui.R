        ...
        mainPanel(
            tabsetPanel(
                tabPanel(title = "Overview", 
                         ...
                         h3("Comparison of Methods"),
                         p("The table and figure below displays a comparison of all methods with respect to their most likely error."),
                ...
                tabPanel(title = "No Stratification",
                         ...
                         shinycssloaders::withSpinner(tableOutput(outputId = "noMainTable"), color = "#FFB682", type = 4, size = 1),
                         shinycssloaders::withSpinner(plotOutput(outputId = "noMainFigure"), color = "#FFB682", type = 4, size = 1)
                ),
                tabPanel(title = "Method of Moments",
                         ...
                         shinycssloaders::withSpinner(plotOutput(outputId = "momentMainFigure"), color = "#FFB682", type = 4, size = 1),
                         h3("Inference on Individual Strata"),
                         shinycssloaders::withSpinner(plotOutput(outputId = "momentStratumFigure"), color = "#FFB682", type = 4, size = 1)
                ),
